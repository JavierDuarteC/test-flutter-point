...
class _$_University with DiagnosticableTreeMixin implements _University {
  ...
  String toString({DiagnosticLevel minLevel = DiagnosticLevel.info}) {
    return 'University(name: $name, country: $country, stateProvince: $stateProvince, alphaTwoCode: $alphaTwoCode, webPages: $webPages, domains: $domains)';
  }
...
abstract class _University implements University {
  const factory _University(
      ...
      @JsonKey(name: "web_pages") final List<String>? webPages,
      final List<String>? domains}) = _$_University;
